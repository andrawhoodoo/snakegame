...
class SnakeSnakeCollisionHandler extends CollisionHandler {
   ...
   * @param {class} snake1 - the Snake actor participating in the collision whose head collided.
   * @param {class} snake2 - the Snake actor participating in the collision who was collided into.
   */
